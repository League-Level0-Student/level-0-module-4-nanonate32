...
public class HappyPet {
	...
	public static void main(String[] args) {
		...
		// 7. REPEAT steps 3 - 6 enough times to make your pet hate you!
		for (int i = 0; i < 6; i++) {
			...
			// pet hate them.
			// (eg: burn them, kill them, or get them sick.).
			// Make sure to customize the title and question too.
			int task = JOptionPane.showOptionDialog(null,
					"What do you want to do want to do to make your pet hate you?", "Death Simulation", 0,
